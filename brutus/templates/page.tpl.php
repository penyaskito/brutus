...
?>
 ...
 <!-- HEADER TOP -->
    ...
    <?php if (!empty($main_menu) || !empty($secondary_menu)): ?>
      <div id="navigation" class="menu <?php if (!empty($main_menu)) { print "with-main-menu"; } if (!empty($secondary_menu)) { print " with-sub-menu"; } ?>">
        <?php if (!empty($main_menu)){ print theme('links', $main_menu, array('id' => 'primary', 'class' => 'links main-menu')); } ?>
        <?php if (!empty($secondary_menu)){ print theme('links', $secondary_menu, array('id' => 'secondary', 'class' => 'links sub-menu')); } ?>
      </div> <!-- /navigation -->
    <?php endif; ?>
